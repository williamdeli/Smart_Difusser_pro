    ...
    */
    ...
    // ie setTime(20, 34, 8, 1, 4, 2023) = 8:34:20 1/4/2021
    struct tm t = {0, 0, 0, 0, 0, 0, 0, 0, 0};      // Initalize to all 0's
    t.tm_year = yr - 1900;    // This is year-1900, so 123 = 2023
    t.tm_mon = mt - 1;  
    t.tm_mday = dy;
    t.tm_hour = hr;
    t.tm_min = mn;
    ...
    // Adjust the day if it's February and a leap year
    if (isLeapYear && t.tm_mon == 1 && t.tm_mday > 28) {
        t.tm_mday = 29;
    }
    if (!isLeapYear && t.tm_mon == 1 && t.tm_mday > 28) {
    t.tm_mday = 28;
  ...
  // Adjust the day if it's April, June, September, or November
  if (( t.tm_mon == 3 || t.tm_mon == 5 || t.tm_mon == 8 || t.tm_mon == 10) && t.tm_mday > 30) {
    t.tm_mday = 30;
  }
